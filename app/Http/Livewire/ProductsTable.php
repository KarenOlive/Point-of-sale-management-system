...
final class ProductsTable extends PowerGridComponent
{
    ...
    */
    public function datasource(): Builder
    {
        ...
        ->join('barcodes', 'products.id', 'barcodes.product_id')
        ->select('products.*', 'categories.category_name as category', 'barcodes.barcode as barcode');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('category')
            ->addColumn('price')
            ->addColumn('metric_units')
            ->addColumn('alert_stock')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('METRIC UNITS', 'metric_units')
                ->sortable()
                ->searchable()
                ,
